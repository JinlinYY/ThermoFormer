...
| `interpretability_earlier/` | Earlier four-table interpretability pipeline and compatibility adapters | Frozen manuscript Figure 2 under `analysis/manuscript_figures/` |
| `interpretability_c1_four_panel/` | Later four-panel C1 grouped-Shapley summary that does not match manuscript Figure 2 | Frozen manuscript Figure 2 under `analysis/manuscript_figures/` |
