...
def main(argv: list[str] | None = None) -> None:
    ...
    run_root = artifact_root / "runs" / "chemical_attention" / args.stage
    checkpoint_root = artifact_root / "checkpoints" / "chemical_attention" / args.stage
    results_root = artifact_root / "results" / "chemical_attention" / args.stage / "runs"
