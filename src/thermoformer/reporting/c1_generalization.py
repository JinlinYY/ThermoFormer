...
def _write_generalization_leaf_records(
    ...
    specifications = (
        ...
        (
            "experiments/predictive_performance/state_generalization/results.md",
        ...
        (
            "experiments/predictive_performance/unseen_components/results.md",
        ...
        (
            "experiments/predictive_performance/binary_to_ternary/results.md",
    ...
    *,
    ...
    if publish_canonical_leaves:
        leaf_paths = [
            ...
            project_root / "experiments/predictive_performance/binary_to_ternary/results.md",
        ]
