...
The complete Chinese result is
`reports/c1_fugacity_complete_performance_report_zh.md`, with the compact English
version at `reports/c1_fugacity_generalization_report.md`; its two machine-readable tables
