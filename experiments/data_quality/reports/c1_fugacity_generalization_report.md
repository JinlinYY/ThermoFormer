...
Machine-readable task metrics and Stage-1/Stage-2 selection diagnostics are stored in `experiments/vle/prediction/summary/c1_fugacity_generalization_by_task.csv` and `experiments/vle/prediction/summary/c1_fugacity_stage_selection.csv`.
