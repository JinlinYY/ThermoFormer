...
commands and human-readable experiments/reference_results under `experiments/<category>/.../config.json`,
...
`experiments/reference_results/<protocol>/seed_<seed>/resolved_config.json`. Formal aggregation verifies
